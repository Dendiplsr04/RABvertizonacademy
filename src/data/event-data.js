...
export const rundownHari1 = {
  ...
  jadwal: [
    ...
    { jam: '13.45 - 14.25', agenda: 'Materi 2', detail: 'Mindset & Mental Closing Marketing', pic: 'Ibu Nany Pujiani', type: 'materi' },
    { jam: '14.30 - 15.10', agenda: 'Materi 3', detail: 'Cara Membangun Personal Branding Marketing Properti', pic: 'Bpk. Vany Firmansyah', type: 'materi' },
    { jam: '15.10 - 15.40', agenda: 'Coffee Break', detail: 'Snack sore & Shalat Ashar.', pic: 'Sarah', type: 'break' },
    { jam: '15.40 - 16.20', agenda: 'Materi 4', detail: 'Teknik Handling Objection Calon Buyer', pic: 'Bpk. Muhammad Arsyad / Ibu Nany Pujiani', type: 'materi' },
    { jam: '16.25 - 17.05', agenda: 'Materi 5', detail: 'Strategi Follow Up yang Efektif', pic: 'Bpk. Dony Firmansyah', type: 'materi' },
